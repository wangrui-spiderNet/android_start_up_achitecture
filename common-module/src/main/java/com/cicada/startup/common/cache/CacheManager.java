...
public class CacheManager {
    ...
    public CacheManager(Context context, String dirName) throws IOException {
        mDiskLruCache = generateCache(context, dirName, MAX_COUNT);
    }

    public CacheManager(Context context, String dirName, int maxCount) throws IOException {
        mDiskLruCache = generateCache(context, dirName, maxCount);
    }

    //custom cache dir
    public CacheManager(File dir) throws IOException {
        mDiskLruCache = generateCache(null, dir, MAX_COUNT);
    }

    public CacheManager(Context context, File dir) throws IOException {
        mDiskLruCache = generateCache(context, dir, MAX_COUNT);
    }

    public CacheManager(Context context, File dir, int maxCount) throws IOException {
    ...
    private File getDiskCacheDir(Context context, String uniqueName) {
        ...
        String cachePath = FileUtils.getCacheFileCachePath(context);
