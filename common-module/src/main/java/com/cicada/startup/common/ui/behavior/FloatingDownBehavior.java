package com.cicada.startup.common.ui.behavior;
 ...
 */
public class FloatingDownBehavior extends CoordinatorLayout.Behavior<View> {
    private static final Interpolator INTERPOLATOR = new DecelerateInterpolator();
    private boolean mIsAnimatingOut = false;
    private boolean mIsScrollToBottom = false;

    public FloatingDownBehavior(Context context, AttributeSet attrs) {
        super();
    }
            ...
            s.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
                ...
                public void onScrollChange(NestedScrollView v, int scrollX, int scrollY,
                    ...
                    if (v.getChildCount() > 0) {
                        ...
                        int diff = (lastView.getBottom() - (v.getHeight() + scrollY));
    ...
    public boolean onStartNestedScroll(final CoordinatorLayout coordinatorLayout, final View child,
        ...
        // 滑动时隐藏软键盘
        UiHelper.hideSoftKeyboard(coordinatorLayout);
