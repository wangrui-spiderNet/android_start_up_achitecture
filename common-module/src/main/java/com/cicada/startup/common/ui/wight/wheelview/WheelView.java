...
package com.cicada.startup.common.ui.wight.wheelview;
...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xFF717171;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xFFb3b3b3;
     ...
     */
    private final int ITEM_OFFSET = TEXT_SIZE / 6;
     ...
     */
    public int DEF_VISIBLE_ITEMS = 5;
    ...
    private Boolean isShowCenterRect = true;// 是否显示选中item的矩形框
    private Boolean isShowDefaultBackground = true;// 是否显示默认背景
    private Boolean isDefaulaTextColor = true;// 是否是有默认的字体颜色
    private int value_text_color = 0;// 选中item的颜色
    private int items_text_color = 0;// 其他item的颜色

    public void setIsShowCenterRect(Boolean isShowCenterRect) {
        this.isShowCenterRect = isShowCenterRect;
    }

    public void setIsShowDefaultBackground(Boolean isShowBackground) {
        this.isShowDefaultBackground = isShowBackground;
    }

    public void setTextColor(int valueTextColor, int itemTextColor) {
        isDefaulaTextColor = false;
        this.value_text_color = valueTextColor;
        this.items_text_color = itemTextColor;
    }
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
            float textWidth = (float) Math.ceil(Layout.getDesiredWidth("数", itemsPaint));
    ...
    private void drawValue(Canvas canvas) {
        ...
        if (labelLayout != null) {
            canvas.save();
            canvas.translate(itemsLayout.getWidth() + 2 * LABEL_OFFSET - 5, bounds.top);
        ...
        if (valueLayout != null) {
            canvas.save();
            canvas.translate(LABEL_OFFSET - 5, bounds.top + scrollingOffset);
    ...
    private void drawItems(Canvas canvas) {
        ...
        canvas.translate(LABEL_OFFSET - 5, -top + scrollingOffset);
