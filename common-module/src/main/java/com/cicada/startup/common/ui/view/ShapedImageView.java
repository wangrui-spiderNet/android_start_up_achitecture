...
public class ShapedImageView extends ImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mBottomLeftRadius = a.getDimension(R.styleable.ShapedImageView_round_bottomLeftRadius, mRadius);
            mBottomRightRadius = a.getDimension(R.styleable.ShapedImageView_round_bottomRightRadius, mRadius);
        ...
        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));//取交集显示下层
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            if (mShape == null) {
                ...
                radius[4] = mBottomRightRadius;
                radius[5] = mBottomRightRadius;
                radius[6] = mBottomLeftRadius;
                radius[7] = mBottomLeftRadius;
